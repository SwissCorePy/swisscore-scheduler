...
scheduler.each.january(5).at(6).run(birthday_congratulation, "Sarah").add_tags("birthday", "sarah")
scheduler.each.july(8).at(6).run(birthday_congratulation, "Patrick").add_tags("birthday", "patrick")
